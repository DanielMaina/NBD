...
namespace NBD_ClientManagementGood.Data
{
    public class ApplicationSeedData
    {
        public static async Task SeedAsync(ApplicationDbContext context, IServiceProvider serviceProvider)
        {
            ...
            string[] roleNames = { "Admin", "Assistant", "Supervisor", "Staff" };
            ...
            if (userManager.FindByEmailAsync("assistant1@outlook.com").Result == null)
            {
                IdentityUser user = new IdentityUser
                {
                    UserName = "assistant1@outlook.com",
                    Email = "assistant1@outlook.com"
                };
